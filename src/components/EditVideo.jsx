    ...
    <>
      <div className="fixed mt-5 top-0 left-0 w-full h-full flex justify-center items-center bg-black bg-opacity-70 z-50">
        <form
          ...
          className=" bg-white space-y-2 border h-[30rem] overflow-y-scroll outline-none p-2"
        >
          <div className="sticky left-0 top-0 z-50 bg-[#eadfdf] flex justify-between items-center border-b border-slate-500 px-3 py-1">
            <div>
          ...
          <div className="p-2 grid lg:grid-cols-2 grid-cols-1 gap-5 z-40">
            ...
            <div className="flex flex-col justify-between focus:bg-[#e7e1e1] sm:gap-0 gap-2">
              <InputVideo
                type="text"
                label="Title *"
                // value={title}
              ...
              <div className="mb-4">
                ...
                <textarea
                  rows="4"
                  className="focus:bg-[#e7e1e1] text-sm overflow-y-scroll bg-transparent outline-none border w-full mt-1 p-1"
